 ...
 * We will stop the shrinking process as soon as we removeFromSortedArry a matched character from the sliding window.
...
public class MinimumWindowSubstring {
    ...
    public static String findSubstring(String str, String pattern) {
        ...
        for (int windowEnd = 0; windowEnd < str.length(); windowEnd++) {
            ...
            // shrink the window if we can, finish as soon as we removeFromSortedArry a matched character
    ...
    public static void main(String[] args) {
        System.out.println(MinimumWindowSubstring.findSubstring("abecde", "abc"));
